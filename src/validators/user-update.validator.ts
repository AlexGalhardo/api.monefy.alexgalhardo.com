...
export const UserUpdateValidator = z.object({
	...
	address_street_name: z.string().min(1, "Street name is required.").optional(),
	address_cep: z
		.string()
	...
	address_street_number: z.number().optional(),
	address_neighborhood: z.string().min(1, "Neighborhood is required.").optional(),
	address_city: z.string().min(1, "City is required.").optional(),
	address_state: z.string().min(1, "State is required.").optional(),
	address_country: z.string().min(1, "Country is required.").optional(),
});
